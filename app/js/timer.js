  ...
  .directive('timer', ['$compile', function ($compile) {
    return  {
      ...
      controller: ['$scope', '$element', '$attrs', '$timeout', function ($scope, $element, $attrs, $timeout) {
        ...
        $scope.countdownTimestamp = new Date().getTime();
        ...
        if ($scope.countdownattr) {
          ...
          $scope.addCDSeconds = $element[0].addCDSeconds = function(extraSeconds){
            ...
            $scope.countdownTimestamp = $scope.countdownTimestamp + (extraSeconds * 1000);
            $scope.$digest();
          };
        ...
        var tick = function () {
          ...
          if ( ($scope.countdownTimestamp + ($scope.countdown * 1000)) - new Date().getTime() <= 0) {
